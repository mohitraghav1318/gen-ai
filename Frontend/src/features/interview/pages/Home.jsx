  ...
  return (
    <div className='home-page'>
      <header className='page-header'>
        ...
        <p>Let AI analyze the job requirements and your profile to build a focused strategy.</p>
      </header>
            ...
            <div className='info-box'>
              <span className='info-box__icon'>
                <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 24 24' fill='currentColor'>
                  ...
                  <line x1='12' y1='16' x2='12.01' y2='16' stroke='#ffffff' strokeWidth='2' />
                </svg>
              </span>
              <p>
                Either a <strong>Resume</strong> or a <strong>Self Description</strong> is required to generate a
                personalized plan.
              </p>
            </div>
          </div>
